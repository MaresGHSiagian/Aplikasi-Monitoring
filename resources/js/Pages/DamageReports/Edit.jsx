...
export default function Edit({ damageReport, stations }) {
    ...
    const [imagePreview, setImagePreview] = useState(
        damageReport.gambar || null
    );

    const handleSubmit = (e) => {
        e.preventDefault();
        post(route("damage-reports.update", damageReport.id));
    };
    ...
    const handleImageChange = (e) => {
        ...
        if (file) {
            ...
            setImagePreview(damageReport.gambar);
        }
    };
    ...
    return (
        ...
        >
            <Head title="Edit Laporan Kerusakan" />
                        ...
                        <div className="p-6">
                            <div className="mb-6">
                                <h3 className="text-lg font-medium text-gray-900">
                                    Edit Laporan Kerusakan #{damageReport.no}
                                </h3>
